...
import { ECS } from "./ecs";
import { Bank, unskilledWork, drawComp, Inventory, isTradeable, skilledWork, wellfareRecievable } from "./Components/components";
...
ecs.addComponent(p2, drawComp, new drawComp("sheap"))
...
//fix tier manager for new ecs system
